...
class DiagnoseQuery extends StatefulWidget {
  const DiagnoseQuery({super.key});

  @override
  State<DiagnoseQuery> createState() => _DiagnoseQueryState();
}

class _DiagnoseQueryState extends State<DiagnoseQuery> {
  ...
  void _submitForm() async {
    ...
    final patient = await PatientService().getPatientByTckn(
      _tcknController.text,
    );
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) =>
                DiagnoseList(patientId: patient!.id, theme: Colors.orange),
      ),
    );
