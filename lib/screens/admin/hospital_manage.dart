...
class _HospitalManageState extends State<HospitalManage> {
  ...
  void _updateHospital() async {
    ...
    if (!hasValueChanged()) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            AppLocalizations.of(context)!.validation_no_change_made,
          ),
        ),
      );
      return;
    ...
    try {
      final updatedHospital = Hospital(
        ...
        username: selectedHospital!.username,
  ...
  bool hasValueChanged() {
    return _nameController.text != selectedHospital!.name ||
        _addressController.text != selectedHospital!.address ||
        selectedDistrict != selectedHospital!.district ||
        _mapsController.text != selectedHospital!.addressLink;
  }
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        AppLocalizations.of(context)!.manage_hospital,
                        style: TextStyle(
                          color: themeColor,
                          fontSize: 30.0,
