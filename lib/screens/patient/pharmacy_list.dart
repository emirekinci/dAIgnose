...
class _PharmacyListState extends State<PharmacyList> {
  ...
  Future<void> _loadPharmacies() async {
    ...
    setState(() {
      pharmacies = result;
      filteredPharmacies = getFilteredPharmacies();
      isLoading = false;
    });
  }
  ...
  List<Pharmacy> getFilteredPharmacies() {
    ...
    return pharmacies
        .where((pharmacy) => pharmacy.district == _selectedDistrict)
        .toList();
  }
                            ...
                            : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    onTap: () {
                                      if (pharmacy.addressLink != null) {
                                        if (pharmacy.addressLink!.isNotEmpty) {
                                          _openMap(pharmacy.addressLink!);
                                          return;
                                        }
                                      }
